...
const companyClear = async () => {
  filters.value.company_uuid = null
  await refresh()
}

const companySelected = async () => {
  filters.value.company_uuid = selectedCompany.value?.uuid || null
  await refresh()
}

// Следим за изменением типов документов
watch(selectedType, async () => {
  filters.value.document_type_ids = selectedType.value.length > 0
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600">
          Загрузка документов ({{ document_response?.count || 0 }})
        </p>
      </div>
      <div class="grid grid-cols-1  md:grid-cols-12 gap-5">
        <div class="col-span-12 md:col-span-4">
          <Card>
            ...
            <template #content>
              ...
              <div class="space-y-2">
                <div class="flex items-center gap-2" v-for="type in document_types" :key="type.id">
                  <Checkbox
        ...
        <div class="col-span-12 md:col-span-8">
          ...
          <div v-else-if="document_response?.results?.length === 0" class="text-center py-8 text-gray-500">
